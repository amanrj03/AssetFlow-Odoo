    ...
    <div className="insighthub-grid-bg" style={{ minHeight: "100vh", color: "var(--text-main)", overflowX: "hidden", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section style={{ paddingBottom: "80px", position: "relative", zIndex: 10 }}>
        <div className="insighthub-mockup-wrapper">
          ...
          <div className="insighthub-circle-dock">
            ...
            <button className="insighthub-circle-btn" title="Allocation Guard" onClick={() => setActiveSandboxTab("allocation")}>
              <Repeat size={20} />
            </button>
            <button className="insighthub-circle-btn" title="SQL Overlap Engine" onClick={() => setActiveSandboxTab("booking")}>
              <Calendar size={20} />
            </button>
            <button className="insighthub-circle-btn" title="Audit Discrepancy" onClick={() => onLaunchERP && onLaunchERP("audit")}>
              <ShieldCheck size={20} />
            </button>
          </div>
          ...
          <div className="insighthub-bg-layer-left">
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
              ...
              <div>
                ...
                <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>BI Reports</div>
              </div>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "28px", textAlign: "left" }}>
          <div className="aceternity-hover-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <button onClick={() => onLaunchERP && onLaunchERP("allocation")} className="btn btn-dark" style={{ padding: "14px 24px", borderRadius: "14px", display: "flex", justifyContent: "space-between", alignItems: "center", fontWeight: 700, fontSize: "0.9rem" }}>
              <span>Go to Allocations & Transfers</span><ArrowRight size={18} />
            </button>
          </div>
          ...
          <div className="aceternity-hover-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <button onClick={() => onLaunchERP && onLaunchERP("booking")} className="btn btn-dark" style={{ padding: "14px 24px", borderRadius: "14px", display: "flex", justifyContent: "space-between", alignItems: "center", fontWeight: 700, fontSize: "0.9rem" }}>
              <span>Go to Resource Bookings</span><ArrowRight size={18} />
            </button>
          </div>
          ...
          <div className="aceternity-hover-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <button onClick={() => onLaunchERP && onLaunchERP("org")} className="btn btn-secondary" style={{ padding: "14px 24px", borderRadius: "14px", display: "flex", justifyContent: "space-between", alignItems: "center", fontWeight: 700, fontSize: "0.9rem", background: "#F8FAFC" }}>
              <span>Go to Hierarchical Directory</span><ArrowRight size={18} />
            </button>
          </div>
          ...
          <div className="aceternity-hover-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <button onClick={() => onLaunchERP && onLaunchERP("audit")} className="btn btn-secondary" style={{ padding: "14px 24px", borderRadius: "14px", display: "flex", justifyContent: "space-between", alignItems: "center", fontWeight: 700, fontSize: "0.9rem", background: "#F8FAFC" }}>
              <span>Go to Audit & Discrepancy</span><ArrowRight size={18} />
            </button>
          </div>
        </div>
      </section>
      ...
      <section id="modules" style={{ padding: "64px 40px 80px 40px", maxWidth: "1480px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 10 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "24px", textAlign: "left" }}>
          {[
            { id: "dashboard", num: "Dashboard", title: "Executive Dashboard", icon: LayoutGrid, desc: "Real-time bento summary across valuations, active assets, audit countdown, and wallet verification." },
            { id: "org", num: "Org Setup", title: "Org Architecture & RBAC", icon: Building2, desc: "Hierarchical departments, custom metadata schemas (`ram: 32GB`), and 4-tier employee role matrix." },
            { id: "assets", num: "Asset Inventory", title: "Asset Inventory & Tag QR", icon: Box, desc: "Master asset directory with QR badge generator, category filtration, and detailed custody logs." },
            { id: "allocation", num: "Allocation", title: "Allocation & Transfer Engine", icon: Repeat, desc: "Enforces `Already allocated` rejection and routes transfer requests (`Employee → Head → Admin`)." },
            { id: "booking", num: "Reservations", title: "Resource Booking Heatmap", icon: Calendar, desc: "Executes non-locking exclusion query `SELECT * FROM bookings WHERE start < $3 AND end > $2`." },
            { id: "maintenance", num: "Maintenance", title: "Maintenance Ticket Lifecycle", icon: Wrench, desc: "Track repairs (`Pending → In Progress → Resolved`), log repair costs, and assign technicians." },
            { id: "audit", num: "Audits", title: "Discrepancy & Audit Engine", icon: ShieldCheck, desc: "Physical vs system count validation, discrepancy flagging, and retirement status tracking." },
            ...
            { id: "notifications", num: "System Logs", title: "Notifications & System Logs", icon: BellRing, desc: "Real-time unread alerts paired with immutable JSON `createActivityLog()` event history." },
          ].map((mod) => (
